...
{
    public class GuestCommunication : OpponentAtHost
    {
        ...
        public GuestCommunication(IPEndPoint endPoint, Guid id, string name)
        {
            EndPoint = endPoint;
        ...
        public GuestCommunication(TcpClient client)
        {
            Client = client;
    ...
    public interface OpponentAtHost
    {
